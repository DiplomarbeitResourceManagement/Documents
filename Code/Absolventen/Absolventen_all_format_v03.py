...
fp=open("L:\GitHub\Documents\Code\Absolventen\Absolventen_all_sozial.csv", "r")
fp1=open("L:\GitHub\Documents\Code\Absolventen\Absolventen_all_format_sozial.csv", "w+")
...
for line in fp.readlines():
  ...
  if parts[7] == "verstorben":	#verstorben
    parts[25] = "1"
  else:
    parts[25] = "0"
  ...
  fp1.write("" + str(nr) + ";"          # nr
			   ...
			   + parts[20] + ";"     	# pemail
			   + parts[21] + ";"     	# ptel
               + parts[22] + ";"     	# xing profil
               + parts[23] + ";"     	# fb profil
               + parts[24] + ";"     	# linkedin profil
               + parts[25] + ";\n")     # verstorben
  nr=nr+1

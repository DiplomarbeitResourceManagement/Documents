...
<form name="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" >
	<p>Kategorie:<br />	<!-- Textfeld zur Eingabe einer neuen Kategorie -->
...
<?php
	if ( $_POST['kname'] != "" )	//Abfrage ob etwas in das Textfeld eingetragen wurde oder ob ein leeres Textfeld gesendet wurde
	{
		echo "<h2>Eintrag gespeichert</h2>";
		$sql = " INSERT INTO kategorie ";
		$sql .= " SET ";
		$sql .= " kname='". $_POST['kname'] ."' ";	//Insert Into Befehl in sql abgespeichert

    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
						<h2>Hauptmenü</h2>		<!-- Titel der Seite -->   
                    </div>
                </div>              
                <!-- /. ROW  -->
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                            <strong>Willkommen im Hauptmenü! </strong> Bitte wählen Sie die entsprechende Aktion aus.	<!-- Information -->
                        </div>
                    </div>
                </div>
                <!-- /. ROW  --> 
                ...
                <div class="row text-center pad-top">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="filter.php"><img src="assets/img/multi.png"width="70"height="70"/></a>  
								<h4>Geräteauswahl</h4>
							</a>
						</div>
                    </div> 
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="labor-eintrag1.php"><img src="assets/img/labor.png"width="70"height="70"/></a>
								<h4>Labortabelle</h4>
							</a>
						</div>
                    </div>
					<!-- Firmeneintrag-Button -->
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="firma-eintrag1.php"><img src="assets/img/firma.jpg"width="70"height="70"/></a>
								<h4>Firmeneintrag</h4>
							</a>
						</div>
                    </div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="standort-eintrag1.php"><img src="assets/img/standort.jpg"width="70"height="70"/></a>
								<h4>Standort</h4>
							</a>
						</div>
                    </div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="kategorie-eintrag1.php"><img src="assets/img/kategorie.png"width="70"height="70"/></a>
								<h4>Kategorie </h4>
							</a>
						</div>
                    </div> 

    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						<h2>Geräteübersicht</h2>	<!-- Titel der Seite -->   
                    </div>
                </div>              
                <?php
					include 'labor-filter.php';		// labor-filter.php ausführen
				?>
				...
				<div class="row text-center pad-top">
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="loeschen.php"><img src="assets/img/del.png"width="70"height="70"/></a>  
								<h4>Löschen</h4>
							</a>
						</div>
					</div>
